//Esse código é funcional, mas o principal problema é que ainda não tínhamos implementado a lógica para acabar com a "tremedeira" da vassoura.
...
const int ANGULO_BAIXO = 255;   // Define o ângulo (em graus) para a vassoura ficar no chão
const int ANGULO_ALTO = 55;   // Define o ângulo (em graus) para a vassoura levantar
...
void levantar_vassoura(){
  servoVassoura.write(ANGULO_ALTO); // Envia o comando do ângulo de 55°
}

void abaixar_vassoura(){
  servoVassoura.write(ANGULO_BAIXO); // Envia o comando de ângulo de 255°
}
